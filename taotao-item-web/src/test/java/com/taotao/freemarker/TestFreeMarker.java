...
public class TestFreeMarker {
    ...
    public void testFreeMarker() throws Exception{
        ...
        //3.设置模板所在的路径
        configuration.setDirectoryForTemplateLoading(new File("D://project/taotao-parent/taotao-item-web/src/main/webapp/WEB-INF/ftl"));
        //4.设置模板的字符集，一般为utf-8
        ...
        Writer out = new FileWriter(new File("D://project/freemarker/out/student.html"));
